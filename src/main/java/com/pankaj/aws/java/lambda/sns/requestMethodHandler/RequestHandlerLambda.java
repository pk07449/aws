...
public class RequestHandlerLambda implements RequestHandler<Request,Response> {
    public Response handleRequest(Request request, Context context) {
        ...
        System.out.println("com.pankaj.aws.java.lambda.sns.requestMethodHandler.RequestHandlerLambda.handleRequest start");
        System.out.println(response);
        System.out.println("com.pankaj.aws.java.lambda.sns.requestMethodHandler.RequestHandlerLambda.handleRequest end");
        return response;
    }
}